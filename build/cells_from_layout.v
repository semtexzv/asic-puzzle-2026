// virtual cells derived from GDS polygons (no Liberty functions)
...
module sky130_fd_sc_hd__a221oi (A1, A2, B1, B2, C1, Y);
  ...
  input C1;
  output Y;
  assign Y = (~A1&~B2&~C1) | (~A2&~B1&~C1) | (~A2&~B2&~C1) | (~A1&~B1&~C1);
endmodule
...
module sky130_fd_sc_hd__a22oi (A1, A2, B1, B2, Y);
  ...
  input B2;
  output Y;
  assign Y = (~A2&~B1) | (~A1&~B2) | (~A2&~B2) | (~A1&~B1);
endmodule
...
module sky130_fd_sc_hd__a41oi (A1, A2, A3, A4, B1, Y);
  ...
  input B1;
  output Y;
  assign Y = (~A1&~B1) | (~A3&~B1) | (~A2&~B1) | (~A4&~B1);
endmodule
...
module sky130_fd_sc_hd__o221a (A1, A2, B1, B2, C1, X);
  ...
  input C1;
  output X;
  assign X = (A2&B2&C1) | (A1&B1&C1) | (A2&B1&C1) | (A1&B2&C1);
endmodule
...
module sky130_fd_sc_hd__o22a (A1, A2, B1, B2, X);
  ...
  input B2;
  output X;
  assign X = (A2&B2) | (A1&B1) | (A2&B1) | (A1&B2);
endmodule
...
module sky130_fd_sc_hd__o2bb2a (A1_N, A2_N, B1, B2, X);
  ...
  input B2;
  output X;
  assign X = (~A2_N&B1) | (~A1_N&B2) | (~A1_N&B1) | (~A2_N&B2);
endmodule
...
module sky130_fd_sc_hd__o311a (A1, A2, A3, B1, C1, X);
  ...
  input C1;
  output X;
  assign X = (A2&B1&C1) | (A3&B1&C1) | (A1&B1&C1);
endmodule
...
module sky130_fd_sc_hd__o32a (A1, A2, A3, B1, B2, X);
  ...
  input B2;
  output X;
  assign X = (A2&B1) | (A3&B2) | (A1&B2) | (A3&B1) | (A2&B2) | (A1&B1);
endmodule
